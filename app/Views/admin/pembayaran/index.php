                ...
                <tbody>
                    <?php foreach ($pembayaran as $item) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('admin/pembayaran/show/' . $item['id']); ?>" class="btn btn-primary btn-sm">Detail</a>
                                <a href="<?= site_url('admin/pembayaran/delete/' . $item['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin?');">Hapus</a>
                                <button class="btn btn-warning btn-sm edit-btn" data-id="<?= $item['id']; ?>" data-pesanan="<?= $item['no_pesanan']; ?>" data-status-pembayaran="<?= $item['checked']; ?>">Edit</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-btn').on('click', function() {
                ...
                let no_pesanan = $(this).data('pesanan');
